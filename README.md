...
I had a problem with my emulator. The emulator was stuck even when I "closed" it. I ended up fixing the problem by doing a cold boot in the AVD manager. I also had a problem with a typo of "context" vs "contest" which took me a while to find.
